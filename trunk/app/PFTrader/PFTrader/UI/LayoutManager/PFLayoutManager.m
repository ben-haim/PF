...
-(void)updateMenuItems
{
   ...
   DDMenuController* top_menu_controller_ = ( DDMenuController* )controller_.topViewController;
   DDMenuController* bottom_menu_controller_ = ( DDMenuController* )controller_.bottomViewController;
   
   [ top_menu_controller_ updateMenuWithItems: [ self menuItemsWithWatchlist: [ PFWatchlist watchlistWithId: @"top_ipad" ] ] ];
   [ bottom_menu_controller_ updateMenuWithItems: [ self menuItemsWithWatchlist: [ PFWatchlist watchlistWithId: @"bottom_ipad" ] ] ];
}
