...
-(void)viewDidLoad
{
   ...
   self.messagePanelView.layer.shadowColor = [ [ UIColor darkGrayColor ] CGColor];
   self.messagePanelView.layer.shadowOpacity = 0.8f;
   self.messagePanelView.layer.shadowRadius = 25.0f;
}
