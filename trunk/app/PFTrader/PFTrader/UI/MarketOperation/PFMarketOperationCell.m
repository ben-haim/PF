...
{
   [ self.topLabel showColouredValue: operation_.operationType == PFMarketOperationBuy ? operation_.amount : ( -1 * operation_.amount ) precision: 0 ];
...
-(void)reloadDataWithOrder:( id< PFOrder > )order_
{
   self.topLabel.text = NSStringFromPFOrderValidityType( order_.validity );
...
@implementation PFOperationStatusCell
