...
-(void)reloadDataWithLevel4Quote: (id<PFLevel4Quote>)level4_quote_
{
   self.topLabel.text = level4_quote_ ? [ NSString stringWithVolume: level4_quote_.askAmount ] : nil;
   self.bottomLabel.text = level4_quote_ ? [ NSString stringWithVolume: level4_quote_.bidAmount ] : nil;
}
