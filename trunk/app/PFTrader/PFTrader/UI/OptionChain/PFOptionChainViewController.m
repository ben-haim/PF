...
-(void)viewDidLoad
{
   ...
   self.expirationSelector.textColor = [ UIColor colorWithWhite: 0.78f alpha: 1.f ];
   self.expirationSelector.borderStyle = UITextBorderStyleNone;
   self.expirationSelector.background = [ UIImage borderedButtonBackgroundImage ];
...
-(void)showOEForLeve4Quote:( id< PFLevel4Quote > )quote_ bidMode:( BOOL )bid_mode_
{
   [ [ [ PFOrderEntryViewController alloc ] initWithLevel4Quote: quote_ bidMode: bid_mode_ ] showControllerWithController: self ];
}

-(void)symbolPriceCell:( PFSymbolPriceCell* )price_cell_ didAskSelectForLeve4Quote:( id< PFLevel4Quote > )quote_
{
   [ self showOEForLeve4Quote: quote_ bidMode: NO ];
}

-(void)symbolPriceCell:( PFSymbolPriceCell* )price_cell_ didBidSelectForLeve4Quote:( id< PFLevel4Quote > )quote_
{
   [ self showOEForLeve4Quote: quote_ bidMode: YES ];
}
