...
@property (nonatomic, weak) id< PFDecimalPadViewDelegate > delegate;

-(PFGrayButton*)createButtonWithTag: (int)tag_;
...
-(PFGrayButton*)createButtonWithTag: (int)tag_
{
   ...
   [ button_ setTitle: (tag_ == -1 ? @"⌫" : ( tag_ == 10 ? @"." : [ NSString stringWithFormat: @"%d", tag_ ]))
