...
{
   return [ self schemeWithProperties: @{
           @"style.chart_general.chart_bg_color": @"0xDCDCDCFF"
           , @"style.chart_general.chart_frame_color": @"0x333333FF"
           , @"style.chart_general.chart_grid_color": @"0xB3B3B3FF"
           , @"style.chart_general.chart_margin_color": @"0xDCDCDCFF"
           , @"style.chart_general.chart_font_color": @"0x333333FF"
           , @"style.chart_general.chart_cursor_color": @"0x333333FF"
           , @"style.chart_general.chart_cursor_textcolor": @"0xFFFFFFFF"
           , @"style.draw.color": @"0x333333FF"
           , @"style.candles.candle_up": @"0x77BC00FF"
           , @"style.candles.candle_up_border": @"0x77A000FF"
           , @"style.candles.candle_down": @"0xEA3700FF"
           , @"style.candles.candle_down_border": @"0xC83700FF"
           , @"style.bars.chart_bars_color": @"0x333333FF"
           , @"style.bars.chart_bars_color_up": @"0x77BC00FF"
           , @"style.bars.chart_bars_color_down": @"0xEA3700FF"
           , @"style.main_line.color": @"0x71A1D1FF"
           , @"style.area.area_fill_color": @"0x71A1D1FF"
...
+(id)greenScheme
{
   return [ self schemeWithProperties: @{
           ...
           , @"style.candles.candle_up": @"0x77BC00FF"
           , @"style.candles.candle_up_border": @"0x77A000FF"
           , @"style.candles.candle_down": @"0x111111FF"
...
+(NSArray*)schemesByType
{
   ...
   if ( !schemes_ )
   {
      schemes_ = @[ [ self darkScheme ], [ self lightScheme ], [ self greenScheme ] ];
   }
   return schemes_;
}
