            ...
            selectedBackground:( UIImage* )selected_image_
{
   ...
   [ selectable_button_ setTitleColor: [ UIColor colorWithWhite: 0.7f alpha: 1.f ] forState: UIControlStateNormal ];
   ...
   selectable_button_.titleLabel.shadowColor = [ UIColor colorWithWhite: 0.4f alpha: 1.f ];
   selectable_button_.titleLabel.shadowOffset = CGSizeMake( 0.f, -1.f );
