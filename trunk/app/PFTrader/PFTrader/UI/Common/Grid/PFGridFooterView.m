...
-(UIButton*)summaryButton
{
   if ( !_summaryButton )
   {
      ...
      _summaryButton.frame = CGRectMake( 0.f, 0.0f, 59.f, 19.f );
      ...
      _summaryButton.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
      _summaryButton.contentEdgeInsets = UIEdgeInsetsMake( 0.f, 10.f, 0.f, 0.f );
      ...
      [ _summaryButton setTitleColor: [ UIColor colorWithWhite: 0.6f alpha: 1.f ] forState: UIControlStateNormal ];

      _summaryButton.titleLabel.font = [ UIFont boldSystemFontOfSize: 12.f ];
