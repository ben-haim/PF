...
@property ( nonatomic, assign, readonly ) BOOL useChangePassword;
@property ( nonatomic, assign, readonly ) BOOL usePrivateLogs;
@property ( nonatomic, assign, readonly ) BOOL useBrandingSecure;
@property ( nonatomic, assign, readonly ) BOOL showFundValues;
@property ( nonatomic, assign, readonly ) BOOL showEquityValue;
@property ( nonatomic, assign, readonly ) BOOL useValidityIOC;
