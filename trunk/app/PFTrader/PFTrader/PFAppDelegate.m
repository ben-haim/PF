...
-(void)logoutSession:( PFSession* )session_
{
   ...
   [((PFTraderSplittedViewController*)self.window.rootViewController).topViewController dismissViewControllerAnimated: NO completion: nil];
   [((PFTraderSplittedViewController*)self.window.rootViewController).bottomViewController dismissViewControllerAnimated: NO completion: nil];
         ...
         withTitle:( NSString* )title_
{
   ...
   {
      local_notification_.alertBody = message_
      ? [ title_ stringByAppendingFormat: @". %@", message_ ]
      : title_;
...
-(BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
   ...
   if ( [ PFBrandingSettings sharedBranding ].brandingServer.length > 0 && [ PFBrandingSettings sharedBranding ].brandingKey.length > 0 )
   {
      [ [ [ PFBrandingManager alloc ] initWithDelegate: self
                                     useBrandingSecure: [ PFBrandingSettings sharedBranding ].useBrandingSecure
