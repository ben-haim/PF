...
{
	[[NSNotificationCenter defaultCenter] postNotificationName:@"tokenResolved" object:base_url];
...
didFailWithError:(NSError *)error
{
	...
	[[NSNotificationCenter defaultCenter] postNotificationName:@"tokenDidntResolve" object:nil];
}
