...
{    
    ...
    {
       if ( ![ splitter_layer splitterModeFromTouches: touches ] && self.showButtonsBlock )
       {
...
- (void)sensor_touchesBegan:(NSSet *)touches
{
    ...
    if(cursorMode==CHART_MODE_CROSSHAIR)//we draw cursors
    {		
