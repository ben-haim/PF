...
-(PFInteger)userId
{
   return [ (PFIntegerField*)[ self stringForKey: PFSearchCriteriaUserId ] integerValue ];
}
...
{
   return [ (PFIntegerField*)[ self stringForKey: PFSearchCriteriaReportType ] integerValue ];
}
