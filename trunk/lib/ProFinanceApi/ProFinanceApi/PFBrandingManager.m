...
@property ( nonatomic, assign ) BOOL useBrandingSecure;
          ...
          brandingKey:( NSString* )branding_key_
{
   ...
   if ( self )
   {
      ...
      self.useBrandingSecure = use_branding_secure_;
