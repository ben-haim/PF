...
static unsigned int PFCurrentOrderIndex = 0;
...
+(id)messageWithCreateOrder:( id< PFOrder > )order_
{
   ...
   else
   {
      ...
      mutable_order_.clientOrderId = ++PFCurrentOrderIndex;
