...
@property ( nonatomic, assign ) unsigned int transferFinishedCount;
...
{
   return [ NSString stringWithFormat: @"count: %d, transferFinishedCount: %d, transferFinished: %d"
           , (int)[ self.mutableApis count ]
           , self.transferFinishedCount
