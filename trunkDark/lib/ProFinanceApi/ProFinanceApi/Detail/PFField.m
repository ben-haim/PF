...
+(NSDictionary*)classMapping
{
   ...
   if ( !mapping_ )
   {
      ...
      , @(PFFieldSessionIsIntaday): [ PFBoolField class ]
      , @(PFFieldSessionAllowedOrderTypes): [ PFArrayField class ]
      , @(PFFieldSessionAllowedOperations): [ PFArrayField class ]
      , @(PFFieldDayIndex): [ PFIntegerField class ]
      , @(PFFieldTradeSessionId): [ PFIntegerField class ]
      , @(PFFieldInitMarginSizeOvernight): [ PFDoubleField class ]
      , @(PFFieldHoldMarginSizeOvernight): [ PFDoubleField class ]
      , @(PFFieldInitMarginSizeShort): [ PFDoubleField class ]
      , @(PFFieldHoldMarginSizeShort): [ PFDoubleField class ]
      , @(PFFieldInitMarginSizeOvernightShort): [ PFDoubleField class ]
      , @(PFFieldHoldMarginSizeOvernightShort): [ PFDoubleField class ]
      , @(PFFieldUseOvernightMargin): [ PFBoolField class ]
      , @(PFFieldUseLongShortMargin): [ PFBoolField class ]
      , @(PFFieldAllowOverhightTrading): [ PFBoolField class ]
      , @(PFFieldTradeSessionCurrentPeriodId): [ PFIntegerField class ]
      , @(PFFieldStopoutType): [ PFIntegerField class ]
      , @(PFFieldDerivativeExpirationTemplate): [ PFIntegerField class ]
      , @(PFFieldPriceLowLimit): [ PFDoubleField class ]
      , @(PFFieldPriceHighLimit): [ PFDoubleField class ]
      , @(PFFieldUseDST): [ PFBoolField class ]
      , @(PFFieldPriceLimitMesure): [ PFByteField class ]
      , @(PFFieldIsDecreaceOnlyPositionCount): [ PFBoolField class ]
      ...
      , @(PFFieldVolumePreMarket): [ PFLongField class ]
      , @(PFFieldVolumePostMarket): [ PFLongField class ]
      , @(PFFieldIsInvestor): [ PFBoolField class ]
      , @(PFFieldAccauntOperationId): [ PFIntegerField class ]
      ...
      , @(PFFieldRebates) : [ PFDoubleField class ]
      , @(PFFieldTodayRebates) : [ PFDoubleField class ]
      };
   }
...
+(NSString*)fieldNameWithId:( PFShort )field_id_
{
   ...
   if ( !names_mapping_ )
   {
      names_mapping_ = @{
                         ...
                         , @(PFFieldBid): @"Bid"
                         , @(PFFieldAsk): @"Ask"
                         , @(PFFieldBidVolume): @"BidSize"
                         , @(PFFieldAskVolume): @"AskSize"
                         , @(PFFieldOpen): @"Open"
                         , @(PFFieldHigh): @"High"
                         , @(PFFieldLow): @"Low"
                         ...
                         , @(PFFieldSessionIsIntaday): @"SessionIsIntaday"
                         ...
                         , @(PFFieldInitMarginSizeOvernight): @"InitMarginSizeOvernight"
                         , @(PFFieldHoldMarginSizeOvernight): @"HoldMarginSizeOvernight"
                         , @(PFFieldInitMarginSizeShort): @"InitMarginSizeShort"
                         , @(PFFieldHoldMarginSizeShort): @"HoldMarginSizeShort"
                         , @(PFFieldInitMarginSizeOvernightShort): @"InitMarginSizeOvernightShort"
                         , @(PFFieldHoldMarginSizeOvernightShort): @"HoldMarginSizeOvernightShort"
                         , @(PFFieldUseOvernightMargin): @"UseOvernightMargin"
                         , @(PFFieldUseLongShortMargin): @"UseLongShortMargin"
                         , @(PFFieldAllowOverhightTrading): @"AllowOverhightTrading"
                         , @(PFFieldTradeSessionCurrentPeriodId): @"TradeSessionCurrentPeriodId"
                         , @(PFFieldStopoutType): @"StopoutType"
                         , @(PFFieldDerivativeExpirationTemplate): @"DerivativeExpirationTemplate"
                         , @(PFFieldPriceLowLimit): @"PriceLowLimit"
                         , @(PFFieldPriceHighLimit): @"PriceHighLimit"
                         , @(PFFieldUseDST): @"UseDST"
                         , @(PFFieldPriceLimitMesure): @"PriceLimitMesure"
                         , @(PFFieldIsDecreaceOnlyPositionCount): @"IsDecreaceOnlyPositionCount"
                         , @(PFFieldDayType): @"DayType"
                         , @(PFFieldErrorCode): @"ErrorCode"
                         ...
                         , @(PFFieldAccauntOperationId): @"AccauntOperationId"
                         ...
                         , @(PFFieldRebates) : @"Rebates"
                         , @(PFFieldTodayRebates) : @"TodayRebates"
                         };
   }
