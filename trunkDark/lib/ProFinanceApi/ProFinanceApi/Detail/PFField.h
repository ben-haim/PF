...
enum
{
   ...
   , PFFieldSessionIsIntaday = 382
   , PFFieldSessionAllowedOrderTypes = 383
   , PFFieldSessionAllowedOperations = 384
   , PFFieldDayIndex = 385
   , PFFieldTradeSessionId = 386
   , PFFieldInitMarginSizeOvernight = 387
   , PFFieldHoldMarginSizeOvernight = 388
   , PFFieldInitMarginSizeShort = 389
   , PFFieldHoldMarginSizeShort = 390
   , PFFieldInitMarginSizeOvernightShort = 391
   , PFFieldHoldMarginSizeOvernightShort = 392
   , PFFieldUseOvernightMargin = 393
   , PFFieldUseLongShortMargin = 394
   , PFFieldAllowOverhightTrading = 395
   , PFFieldTradeSessionCurrentPeriodId = 396
   , PFFieldStopoutType = 397
   , PFFieldDerivativeExpirationTemplate = 398
   , PFFieldPriceLowLimit = 399
   , PFFieldPriceHighLimit = 400
   , PFFieldUseDST = 401
   , PFFieldPriceLimitMesure = 402
   , PFFieldIsDecreaceOnlyPositionCount = 403
   , PFFieldDayType = 404
...
enum
{
   ...
   , PFGroupQuoteBar = 23
   , PFGroupOrderIdAmont = 24
   , PFGroupKeyValueAggregate = 25
   , PFGroupExpiration = 26
   , PFGroupSpreadLevel = 27
   , PFGroupCommissionLevel = 28
   , PFGroupMargin = 29
   , PFGroupClusterNode = 30
   , PFGroupTradeSessionPeriod = 31
   , PFGroupMarginCoefficient = 32
   , PFGroupHoliday = 33
   , PFGroupCrossRate = 34
   , PFGroupCommission = 35
   , PFGroupCommissionValue = 36
   , PFGroupAssetAccount = 37
};
