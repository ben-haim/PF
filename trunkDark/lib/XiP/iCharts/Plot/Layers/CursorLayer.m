...
-(UIImage*)cropImage:(UIImage*)originalImage toRect:(CGRect)rect
{
    ...
    CGContextSetFillColorWithColor(bitmap, [ UIColor colorWithRed: 26.f / 255.f green: 27.f / 255.f blue: 30.f / 255.f alpha: 1.f ].CGColor);
