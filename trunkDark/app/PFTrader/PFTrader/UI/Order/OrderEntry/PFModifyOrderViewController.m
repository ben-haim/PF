...
+(void)showWithOrder:( id< PFOrder > )order_
{
   [ [ [ PFModifyOrderViewController alloc ] initWithOrder: order_ ] showAsDialog ];
}
...
-(void)updateButtonsVisibility
{
   ...
   self.cancelButton.hidden = YES; //![ [ PFSession sharedSession ] allowsCancelOperationsForSymbol: self.order.symbol ];
