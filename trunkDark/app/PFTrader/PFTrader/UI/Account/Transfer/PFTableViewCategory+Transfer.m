...
{
   __weak PFAccountTransferViewController* weak_controller_ = controller_;
   ...
   account_item_.pickerAction = ^( PFTableViewBasePickerItem* picker_item_ )
   {
      ...
      if ( new_target_account_ != weak_controller_.targetAccount )
      {
         weak_controller_.targetAccount = new_target_account_;
         [ weak_controller_ updateTargetAccount ];
      }
   };
