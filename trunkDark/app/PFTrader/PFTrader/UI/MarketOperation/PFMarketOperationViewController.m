...
-(void)close
{
   [ self.pfNavigationController.formSheetController mz_dismissFormSheetControllerAnimated: YES
...
-(void)showAsDialog
{
   PFNavigationController* navigation_controller_ = [ PFNavigationController navigationControllerWithController: self ];
