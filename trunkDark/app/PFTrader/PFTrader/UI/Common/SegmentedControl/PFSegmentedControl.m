            ...
            selectedBackground:( UIImage* )selected_image_
{
   ...
   [ selectable_button_ setTitleColor: [ UIColor blueTextColor ] forState: UIControlStateNormal ];
...
+(id)leftButtonWithTitle:( NSString* )title_
{
   return [ self selectableButtonWithTitle: title_
                        ...
                        selectedBackground: [ UIImage selectedSegmentClickBackground ] ];//selectedLeftSegmentBackground ] ];
}
...
+(id)centerButtonWithTitle:( NSString* )title_
{
   return [ self selectableButtonWithTitle: title_
                        ...
                        selectedBackground: [ UIImage selectedSegmentClickBackground ] ];//selectedCenterSegmentBackground ] ];
}
...
+(id)rightButtonWithTitle:( NSString* )title_
{
   return [ self selectableButtonWithTitle: title_
                        ...
                        selectedBackground: [ UIImage selectedSegmentClickBackground ] ];//selectedRightSegmentBackground ] ];
}
...
-(void)applyStyle
{
   ...
   self.image = [ UIImage segmentBackground ];
}
