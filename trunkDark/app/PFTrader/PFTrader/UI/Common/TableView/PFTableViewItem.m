...
-(UITableViewCell*)cellForTableView:( UITableView* )table_view_
{
   ...
   {
      cell_.accessoryView = [ [ UIImageView alloc ] initWithImage: cell_.useWhiteAccessoryImage ? [ UIImage tableAccessoryIndicatorImageWhite ] : [ UIImage tableAccessoryIndicatorImage ] ];
   }
   else
   {
