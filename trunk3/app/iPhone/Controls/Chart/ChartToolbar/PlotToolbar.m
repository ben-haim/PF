...
- (void)setupChartToolbar
{
    ...
    seg_draw.selectedSegmentTag = ID_SEG_NONE;
    
    btn = [[ToolbarButton alloc] initWithTag:ID_BTN_SETTINGS AndScale:current_scale AndDelegate:tb_delegate];
    ToolbarButtonSegment* seg_set = [btn addSegment:ID_SEG_SETTINGS WithText:nil AndImage:[UIImage imageNamed:@"menu_show.png"]];
    btn.frame = CGRectIntegral(CGRectMake(current_x, CHART_BTN_TOP_PADDING, CHART_BTN_WIDTH, CHART_BTN_HEIGHT)); 
    [self.layer addSublayer:btn];
    [buttons addObject:btn];
    [btn release];  
    ...
    seg_set.rows_count = 2;
    seg_set.cols_count = 3;
    [seg_set addSubSegment:ID_SUBSEG_S1         WithText:nil      AndImage:[UIImage imageNamed:@"palette_1.png"]];
    [seg_set addSubSegment:ID_SUBSEG_S2         WithText:nil      AndImage:[UIImage imageNamed:@"palette_2.png"]];         
    [seg_set addSubSegment:ID_SUBSEG_S3        WithText:nil     AndImage:[UIImage imageNamed:@"palette_3.png"]]; 
    [seg_set addSubSegment:ID_SUBSEG_S4        WithText:nil     AndImage:[UIImage imageNamed:@"palette_4.png"]]; 
    [seg_set addSubSegment:ID_SUBSEG_S5         WithText:nil      AndImage:[UIImage imageNamed:@"palette_5.png"]];    
    [seg_set addSubSegment:ID_SUBSEG_S6          WithText:nil      AndImage:[UIImage imageNamed:@"menu_show.png"]];   
