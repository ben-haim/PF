...
-(UIButton*)button
{
   ...
   [ button_ setImage: self.highlightedImage forState: UIControlStateHighlighted ];
   return button_;
}
...
{
   return [ self initWithActions: actions_
                             row: row_
                       fixedWith: fixed_width_
                   startFromZero: NO ];
}
       ...
       startFromZero:( BOOL )start_from_zero_
{
   ...
   if ( self )
   {
      ...
      CGFloat action_size_ = 34.f;
      CGFloat horyzontal_margin_ = 18.f;
      CGRect action_rect_ = CGRectMake( start_from_zero_ ? 0.f : horyzontal_margin_ / 2.f
      ...
      UIImageView* image_view_ = [ [ UIImageView alloc ] initWithImage: nil ];
      ...
      UIImageView* overlay_image_view_ = [ [ UIImageView alloc ] initWithImage: nil ];
