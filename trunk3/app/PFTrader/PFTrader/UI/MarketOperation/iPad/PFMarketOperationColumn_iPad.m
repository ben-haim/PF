...
+(id)statusColumn
{
   return [ self columnWithTitle: NSLocalizedString( @"STATUS", nil )
                       cellClass: [ PFOperationStatusCell_iPad class ] ];
}

+(id)instrumentTypeColumn
{
   return [ self columnWithTitle: NSLocalizedString( @"INSTRUMENT_TYPE", nil )
                       cellClass: [ PFOperationInstrumentTypeCell_iPad class ] ];
}

+(id)boughtColumn
{
   return [ self columnWithTitle: NSLocalizedString( @"BOUGHT", nil )
                       cellClass: [ PFOperationBoughtCell_iPad class ] ];
}

+(id)soldColumn
{
   return [ self columnWithTitle: NSLocalizedString( @"SOLD", nil )
                       cellClass: [ PFOperationSoldCell_iPad class ] ];
}
