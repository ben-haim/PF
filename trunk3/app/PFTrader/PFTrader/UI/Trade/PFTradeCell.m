...
{
   self.topLabel.text = [ NSString stringWithAmount: trade_.grossPl lotStep: trade_.symbol.instrument.lotStepExp1 ];
...
-(void)reloadDataWithTrade:( id< PFTrade > )trade_
{
   self.topLabel.text = [ NSString stringWithAmount: trade_.netPl lotStep: trade_.symbol.instrument.lotStepExp1 ];
