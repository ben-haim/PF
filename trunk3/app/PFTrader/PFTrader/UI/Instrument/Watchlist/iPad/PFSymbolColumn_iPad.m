...
+(id)settlementPriceColumn
{
   return [ self columnWithTitle: NSLocalizedString( @"SETTLEMENT_PRICE", nil )
                       cellClass: [ PFSymbolSettlementPriceCell_iPad class ] ];
}

+(id)prevSettlementPriceColumn
{
   return [ self columnWithTitle: NSLocalizedString( @"PREV_SETTLEMENT_PRICE", nil )
                       cellClass: [ PFSymbolPrevSettlementPriceCell_iPad class ] ];
}
