...
{
   return [ self columnWithTitle: NSLocalizedString( @"SETTLEMENT_PRICE", nil )
                     secondTitle: NSLocalizedString( @"PREV_SETTLEMENT_PRICE", nil )
                       cellClass: [ PFSymbolSettlementPriceCell class ] ];
}

+(id)openInterestColumn
{
   return [ self columnWithTitle: NSLocalizedString( @"OPEN_INTEREST", nil )
                       cellClass: [ PFSymbolOpenInterestCell class ] ];
}
