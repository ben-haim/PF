...
static const float defaultSplitterTopPart = 0.7;
...
@synthesize showModalForms;
@synthesize splitterTopPart;
@synthesize splitterState;
...
-(id)init
{
   ...
   if ( self )
   {
      ...
      self.showModalForms = NO;
      self.splitterTopPart = defaultSplitterTopPart;
      self.splitterState = PFSplittedViewStateTopFullscreen;
...
-(id)initWithCoder:( NSCoder* )coder_
{
   ...
   if ( self )
   {
      ...
      self.showModalForms = [ coder_ decodeBoolForKey: @"showModalForms" ];
      self.splitterState = [ coder_ decodeIntForKey: @"splitterState" ];
      
      float splitter_top_part_ = [ coder_ decodeFloatForKey: @"splitterTopPart" ];
      self.splitterTopPart = splitter_top_part_ > 0.0 ? splitter_top_part_ : defaultSplitterTopPart;
...
-(void)encodeWithCoder:( NSCoder* )coder_
{
   ...
   [ coder_ encodeBool: self.showModalForms forKey: @"showModalForms" ];
   [ coder_ encodeInt: self.splitterState forKey: @"splitterState" ];
   [ coder_ encodeFloat: self.splitterTopPart forKey: @"splitterTopPart" ];
