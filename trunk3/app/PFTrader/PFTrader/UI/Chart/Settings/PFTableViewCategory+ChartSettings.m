...
+(id)additionalCategoryWithSettings:( PFChartSettings* )initial_settings_
{
   ...
   PFTableViewSwitchItem* show_loupe_item_ = [ PFTableViewSwitchItem switchItemWithTitle: NSLocalizedString( @"SHOW_LOUPE", nil )
                                                                                    isOn: initial_settings_.showLoupe
                                                                            switchAction: nil ];
   show_loupe_item_.applier = ^( PFTableViewItem* item_, PFChartSettings* settings_ )
   {
      settings_.showLoupe = [ (PFTableViewSwitchItem*)item_ on ];
   };
