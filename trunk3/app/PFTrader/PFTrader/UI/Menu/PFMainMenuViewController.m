...
-(void)loadView
{
   ...
   CGFloat menu_horisontal_offset_ = 20.f;
   CGFloat menu_vertical_offset_ = 10.f;

   CGRect display_rect_ = self.view.bounds;
   display_rect_.origin.x = menu_horisontal_offset_;
   display_rect_.origin.y = menu_vertical_offset_;
   display_rect_.size.width = [ DDMenuController displayControllerWidth ] - menu_horisontal_offset_ * 2;
...
-(void)viewDidLoad
{
   ...
   self.view.backgroundColor = [ UIColor colorWithRed: 26.f / 255 green: 26.f / 255 blue: 26.f / 255 alpha: 1.f ];
