...
typedef enum
{
   ...
   , PFInstrumentMarginTypeNone = 4
   , PFInstrumentMarginTypeExposition = 5
   , PFInstrumentMarginTypeOptions = 6
   , PFInstrumentMarginTypeSetlemen = 7
   , PFInstrumentMarginTypePFS_ACC = 10
   , PFInstrumentMarginTypeTreg = 11
} PFInstrumentMarginType;
...
-(PFInstrumentMarginType)marginType;
...
-(PFBool)useLongShortMargin;
-(PFBool)useOvernightMargin;
...
@property ( nonatomic, assign, readonly ) PFBool isForward;
@property ( nonatomic, assign, readonly ) PFBool isDerivative;
...
@property ( nonatomic, assign ) PFBool useLongShortMargin;
@property ( nonatomic, assign ) PFBool useOvernightMargin;
